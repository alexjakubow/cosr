...
The goal of `cosr` is to facilitate the exploration and analysis of open
science practices and resource lifecycles using data from the Open
Science Framework.

Unlike
[`osf.io`](https://github.com/CenterForOpenScience/osf.io/tree/develop/osf),
`cosr` is:

- An R package, not a web application/service.
- Built for data analysis and exploration, not database management and
  software development.
- Tailored for researchers and data scientists interested in open
  science metrics.
- Provides functions to process and analyze OSF data programmatically,
  reproducibly, and interactively.
- Designed to work with columnar data formats (e.g., Parquet) for
...
The `cosr` package is organized by user experience level to make it easy
to find the functions you need:
